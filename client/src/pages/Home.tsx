      ...
      <section className="relative overflow-hidden bg-navy">
        ...
        <div className="container relative z-10 py-20 md:py-28 lg:py-36">
          <div className="max-w-2xl">
            ...
            >
              Your health is our <span className="text-marigold">passion.</span>
            </motion.h1>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative z-10 py-16 md:py-24">
          ...
          >
            ...
            >
              COVID-19, Flu, Shingles, Pneumonia, Tdap, HPV, and more — all
              available at Toledo Pharmacy. No appointment needed, just walk in!
            ...
            >
              <div className="flex">
                {[...Array(5)].map((_, i) => (
                  <Star
                    key={i}
                    className="w-6 h-6 text-marigold fill-marigold"
                  />
                ))}
              </div>
              ...
              >
                <div className="flex mb-3">
                  {[...Array(5)].map((_, j) => (
                    <Star
                      key={j}
                      className="w-4 h-4 text-marigold fill-marigold"
                    />
                  ))}
                </div>
