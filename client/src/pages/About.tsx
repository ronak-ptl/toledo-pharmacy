...
const TEAM_IMG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663492047795/CBkFvG4mcJ8DQojrBJ59Fz/pharmacy-team-Gcs6aoK2Y2sFTDZ5tWgFFx.webp";
const COMMUNITY_IMG =
...
const HERO_IMG =
  "https://d2xsxph8kpxj0f.cloudfront.net/310519663492047795/CBkFvG4mcJ8DQojrBJ59Fz/hero-pharmacy-NNBzxgMYoJH5SHhL8ZDxic.webp";
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                ...
                located in the heart of Union City, NJ. With over 40 years of
                experience serving the local community, we are proud to be a
                trusted healthcare provider for our customers.
              </motion.p>
              <motion.p
                custom={2}
                variants={fadeUp}
                className="text-navy/60 text-base leading-relaxed mb-4 font-body"
              >
                At Toledo Pharmacy, we take pride in providing personalized
                attention and care to our customers. We understand that each
                individual has unique healthcare needs, and we take the time to
                listen to our customers and offer tailored advice and guidance.
              </motion.p>
              <motion.p
                custom={3}
                variants={fadeUp}
                className="text-navy/60 text-base leading-relaxed mb-4 font-body"
              >
                Our experienced pharmacists and staff members are committed to
                providing top-notch pharmaceutical care to our customers, and we
                always go above and beyond to ensure that each person feels
                heard and supported.
              </motion.p>
              <motion.p
                custom={4}
                variants={fadeUp}
                className="text-navy/50 text-sm italic font-body"
              >
        ...
        <div className="container">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
            ...
            >
              ...
              >
                We offer a wide range of services to meet all your healthcare
                needs, prioritizing convenience and affordability.
              </motion.p>
      ...
      <section className="bg-navy py-16 md:py-20">
        <div className="container text-center">
          ...
          >
            ...
            >
              We are honored to serve the Union City community and look forward
              to providing you with the personalized attention and care that you
              deserve.
            </motion.p>
            <motion.div
              custom={2}
